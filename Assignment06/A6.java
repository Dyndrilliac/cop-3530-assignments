...
public class A6
{
    ...
    private void printResultsTable(final boolean isProbeLinear)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            double[] output = {
                A6.LOAD_FACTORS[i], empiricalSuccess, this.empirSuccessCounter[index], theoreticalSuccess, empiricalFailure,
                this.empirFailureCounter[index], theoreticalFailure
            };
    ...
    public void promptInput()
    {
        ...
        int[] iArgs = {
            Integer.parseInt(sArgs[0]), Integer.parseInt(sArgs[1])
        };
